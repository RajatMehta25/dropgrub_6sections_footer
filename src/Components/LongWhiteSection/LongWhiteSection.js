...
<div className="btn-align" style={{textAlign:"center",marginTop:20}}>
                      
                      <SubmitButtonWrapper name="submit" sx={{backgroundColor:"#2B3BF6",color:"#fff",font: "normal normal normal 16px/25px Poppins"}}>Submit</SubmitButtonWrapper>
                    </div>
